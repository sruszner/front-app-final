            ...
            <div class="container marketing">
                ...
                <div class="row featurette">
                    <div class="col-md-7">
                        <h2 class="featurette-heading">
                            Hypercar
                            <span class="text-muted"> makes its debut</span>
                        </h2>
                        <p class="lead">
                    ...
                    <div class="col-md-5">
                        <Link to="/404error" target="_blank" rel="noopener noreferrer">
                            <img src="../../../../assets/media/lmp1note3.jpg" alt="LMP1 1" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="700" height="700" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false" />
                        </Link>
                    </div>
                </div>
                ...
                <div class="row featurette">
                    <div class="col-md-7 order-md-2">
                        <h2 class="featurette-heading">
                            A word on
                            <span class="text-muted"> Oliver Gavin</span>
                        </h2>
                        <p class="lead">
                    ...
                    <div class="col-md-5 order-md-1">
                        <Link to="/404error" target="_blank" rel="noopener noreferrer">
                            <img src="../../../../assets/media/lmp1note2.jpg" alt="LMP1 2" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="700" height="700" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false" />
                        </Link>
                    </div>
                </div>
                ...
                <div class="row featurette">
                    <div class="col-md-7">
                        <h2 class="featurette-heading">
                            ...
                            <span class="text-muted"> for Aston Martin</span>
                        </h2>
                        <p class="lead">
                    ...
                    <div class="col-md-5">
                        <Link to href="/404error" target="_blank" rel="noopener noreferrer">
                            <img src="../../../../assets/media/lmp1note.jpg" alt="LMP1 3" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="700" height="700" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false" />
                        </Link>
                    </div>
                </div>
