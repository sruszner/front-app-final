                ...
                <div className="col-4 offset-1">
                    ...
                    <div className="d-flex justify-content-between py-4 my-4 border-top">
                        ...
                        <ul className="list-unstyled d-flex">
                            <li className="ms-3"><Link className="link-dark"
                                    to="https://www.instagram.com/circuit_spa_francorchamps/?hl=es" target="_blank">
                            ...
                            <li className="ms-3"><Link className="link-dark" to="https://es-la.facebook.com/circuitspa/"
                                    target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <li className="ms-3"><Link className="link-dark" to="https://twitter.com/circuitspa" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
