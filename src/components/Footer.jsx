...
function Footer() {
    ...
    return (
        <footer className="container-lg py-5">
            <div className="row">
                <div className="col-2">
                    ...
                    <ul className="nav flex-column">
                        <li className="nav-item mb-2"><Nav.Link href="/" target="_top" className="nav-link p-0 text-muted">Circuit</Nav.Link></li>
                        <li className="nav-item mb-2"><Nav.Link href="/region" target="_top" className="nav-link p-0 text-muted">Region</Nav.Link> </li>
                        <li className="nav-item mb-2"><Nav.Link href="/formula" target="_top" className="nav-link p-0 text-muted">Formula One</Nav.Link></li>
                        <li className="nav-item mb-2"><Nav.Link href="/gt3" target="_top" className="nav-link p-0 text-muted">GT3</Nav.Link></li>
                        <li className="nav-item mb-2"><Nav.Link href="/lmp1" target="_top" className="nav-link p-0 text-muted">LMP1</Nav.Link></li>
                    </ul>
                </div>
                ...
                <div className="col-2">
                    ...
                    <ul className="nav flex-column">
                        ...
                        <li className="nav-item mb-2"><Nav.Link href="/404error" target="_top" className="nav-link p-0 text-muted">Events</Nav.Link>
                        </li>
                        <li className="nav-item mb-2"><Nav.Link href="/404error" target="_top" className="nav-link p-0 text-muted">News</Nav.Link> </li>
                    </ul>
                </div>
                ...
                <div className="col-2">
                    ...
                    <ul className="nav flex-column">
                        ...
                        <li className="nav-item mb-2"><Nav.Link href="/404error" target="_top" className="nav-link p-0 text-muted">Press</Nav.Link> </li>
                    </ul>
                </div>
                ...
                <div className="col-4 offset-1">
                    ...
                    <div className="d-flex justify-content-between py-4 my-4 border-top">
                        <p>&copy; 2022 Spa-Francorchamps. All rights reserved.</p>
                        <ul className="list-unstyled d-flex">
                            <li className="ms-3"><Nav.Link className="link-dark" href="https://www.instagram.com/circuit_spa_francorchamps/?hl=es" target="_blank">
                            ...
                            <li className="ms-3"><Nav.Link className="link-dark" href="https://es-la.facebook.com/circuitspa/" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <li className="ms-3"><Nav.Link className="link-dark" href="https://twitter.com/circuitspa" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <MDBModal tabIndex='-1' show={subscribedModal} setShow={setCentredModal0}>
