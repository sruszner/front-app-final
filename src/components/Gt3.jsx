                ...
                <div className="container marketing">
                    ...
                    <div className="row featurette">
                        <div className="col-md-7">
                            <h2 className="featurette-heading">
                                ...
                                <span className="text-muted"> at SPA</span>
                            </h2>
                            <p className="lead">
                        ...
                        <div className="col-md-5">
                            <Link to="/404error" target="_blank" rel="noopener noreferrer">
                                <img src="../assets/media/gt31.webp" alt="GT3 1" className="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="700" height="700" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false" />
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="row featurette">
                        <div className="col-md-7 order-md-2">
                            <h2 className="featurette-heading">
                                ST Racing claims
                                <span className="text-muted"> first win for the BMW M4 GT3.</span>
                            </h2>
                            <p className="lead">
                        ...
                        <div className="col-md-5 order-md-1">
                            <Link to="/404error" target="_blank" rel="noopener noreferrer">
                                <img src="../assets/media/gt32.jpeg" alt="GT3 2" className="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="700" height="700" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false" />
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="row featurette">
                        <div className="col-md-7">
                            <h2 className="featurette-heading">
                                ...
                                <span className="text-muted"> enters Spa with NSX GT3</span>
                            </h2>
                            <p className="lead">
                        ...
                        <div className="col-md-5">
                            <Link to="/404error" target="_blank" rel="noopener noreferrer">
                                <img src="../assets/media/gt33.jpg" alt="GT3 3" className="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="700" height="700" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false" />
                            </Link>
                        </div>
                    </div>
                    <hr className="featurette-divider" />
