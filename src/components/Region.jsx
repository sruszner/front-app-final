...
function Region() {
    return (
        <Container>
            <div className="p-4 p-md-5 mb-4 mt-5 text-white rounded bg-dark">
                <div className="col-md-6 px-0">
                    <h1 className="display-4 fst-italic text-danger">
                        Land of Francorchamps: the richness of authenticity
                    </h1>
                    <p className="lead my-3">The Circuit of Spa Francorchamps is located in the magnificent region of the Ardennes, in a natural, breathtaking, verdant setting. <br /> Near Fagnes and its highly-regarded landscapes, it offers you a range of very diversified activities
                    </p>
                </div>
            </div>
            <div className="row g-5">
                <div className="col-md-8">
                    ...
                    <div className="blog-post">
                        <h2 className="blog-post-title">Stavelot</h2>
                        <hr />
                        <p>
                        ...
                        <div className="col-md-5">
                            <img src="../../assets/media/ciudad.jpg" alt="Circuito 1" className="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="700" height="700" preserveAspectRatio="xMidYMid slice" focusable="false" />
                            <hr />
                        </div>
                        <h2 className="blog-post-title">Malmedy</h2>
                        <hr />
                        ...
                        <div className="col-md-5">
                            <img src="../../assets/media/bosque.jpg" alt="Circuito 1" className="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="700" height="700" preserveAspectRatio="xMidYMid slice" focusable="false" />
                            <hr />
                        </div>
                        <div>
                ...
                <section className="col-md-4">
                    <div className="articulo position-sticky">
                        <div className="p-4 mb-3 bg-light rounded">
                            <h4 className="fst-italic">About</h4>
                            <p className="mb-0">Visit our blog and read this month's news highlights and anything else of interest to you.</p>
                        </div>
                        <div className="p-4">
                            <h4 className="fst-italic">News</h4>
